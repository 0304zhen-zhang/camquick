$(function(){
	...
	var render = function(){
		...
		for(var i=1;i<=total;i++){
			...
			li+='<li data-id="'+i+'" class="animated bounceIn" style="width:'+picWidth+'px;height:'+picWidth+'px;padding-left:'+p+'px;padding-top:'+padding+'px;"><img  class="lazy" data-original="img/'+i+'.jpg"></li>';
		}
			$('#container').html(li);
	}
	render();
